...
function ReviewDraft(props: ReviewProps) {
  ...
  return <div className="surface-stack">{!runtimeReady && <section className="inline-refusal"><AlertTriangle /><div><strong>Submission intake degraded</strong><p>Select the exact signed Vela v0.977.2 runtime. Capture and local export remain available.</p></div></section>}
